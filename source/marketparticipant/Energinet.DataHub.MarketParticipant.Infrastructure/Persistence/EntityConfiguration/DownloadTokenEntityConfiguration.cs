...
public class DownloadTokenEntityConfiguration : IEntityTypeConfiguration<DownloadTokenEntity>
{
    public void Configure(EntityTypeBuilder<DownloadTokenEntity> builder)
    {
