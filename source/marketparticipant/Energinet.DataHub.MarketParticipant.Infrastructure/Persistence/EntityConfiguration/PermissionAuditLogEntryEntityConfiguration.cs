...
{
    public class PermissionAuditLogEntryEntityConfiguration : IEntityTypeConfiguration<PermissionAuditLogEntryEntity>
    {
        public void Configure(EntityTypeBuilder<PermissionAuditLogEntryEntity> builder)
        {
