...
public sealed class DelegationPeriodEntityConfiguration : AuditedEntityTypeConfiguration<DelegationPeriodEntity>
{
    protected override void ConfigureEntity(EntityTypeBuilder<DelegationPeriodEntity> builder)
    {
