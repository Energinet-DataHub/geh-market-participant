...
public sealed class UserInviteEmailTemplate : EmailTemplate
{
    public UserInviteEmailTemplate(UserIdentity userIdentity, Organization organization, Actor actor)
        : base(EmailTemplateId.UserInvite, PrepareParameters(userIdentity, organization, actor))
    {
    }
