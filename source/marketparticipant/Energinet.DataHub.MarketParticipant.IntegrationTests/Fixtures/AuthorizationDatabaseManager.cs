...
public sealed class AuthorizationDatabaseManager : SqlServerDatabaseManager<AuthorizationDbContext>
{
    public AuthorizationDatabaseManager()
        : base("MarketParticipant")
    {
    }

    public override AuthorizationDbContext CreateDbContext()
    {
    ...
    /// </summary>
    protected override async Task<bool> CreateDatabaseSchemaAsync(AuthorizationDbContext context)
    {
