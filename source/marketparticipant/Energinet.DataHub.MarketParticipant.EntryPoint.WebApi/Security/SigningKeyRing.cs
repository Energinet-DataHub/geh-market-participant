...
public sealed class SigningKeyRing : ISigningKeyRing
{
    ...
    public async Task<CryptographyClient> GetSigningClientAsync()
    {
        ...
        var latestKey = keyCache
            ...
            .First(key => !key.Properties.CreatedOn.HasValue || key.Properties.CreatedOn < currentTime.AddMinutes(-10) || MarketParticipantWebApiAssemblyForTesting.EnableIntegrationTestKeys);
