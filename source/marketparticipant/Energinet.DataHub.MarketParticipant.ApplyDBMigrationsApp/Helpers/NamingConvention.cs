...
namespace Energinet.DataHub.MarketParticipant.ApplyDBMigrationsApp.Helpers
{
    public static class NamingConvention
    {
        ...
        public static readonly Regex Regex = new Regex(@".*Scripts\.(?<environment>T_001|T_002|U_001|U_002|B_001|B_002|P_001|D_001|D_002|LocalDB)(\.(?<type>Model|Seed|Test))?\.(?<timestamp>\d{12}) (?<name>\D*).sql");
    }
}
