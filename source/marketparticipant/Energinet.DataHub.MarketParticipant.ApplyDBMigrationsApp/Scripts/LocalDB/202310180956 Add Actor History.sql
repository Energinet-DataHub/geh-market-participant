ALTER TABLE [dbo].[Actor] ADD
    ...
    CONSTRAINT DF_Actor_PeriodStart DEFAULT SYSUTCDATETIME(),
    PeriodEnd DATETIME2 GENERATED ALWAYS AS ROW END HIDDEN
    CONSTRAINT DF_Actor_PeriodEnd   DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
...
ALTER TABLE [dbo].[Actor]
    SET (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.[ActorHistory]));
GO
...
ALTER TABLE [dbo].[Actor]
    ADD CONSTRAINT CHK_Actor_ChangedByIdentityId_NotEmpty CHECK (ChangedByIdentityId <> '00000000-0000-0000-0000-000000000000');
GO