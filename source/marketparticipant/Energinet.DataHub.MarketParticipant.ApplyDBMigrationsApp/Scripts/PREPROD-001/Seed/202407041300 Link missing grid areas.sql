...
BEGIN
    ...
    VALUES (@ActorId, 'Actor', 0, GETDATE(), '{"actorNumber":{"$type":"gln","type":1,"value":"' + @ActorNumber + '"},"actorRole":14,"gridAreaId":{"value":"' + CONVERT(NVARCHAR(36), @GridAreaId) + '"},"validFrom":"2024-01-01T23:00:00Z","eventId":"' + CONVERT(NVARCHAR(36), NEWID()) + '"}', 'GridAreaOwnershipAssigned')
