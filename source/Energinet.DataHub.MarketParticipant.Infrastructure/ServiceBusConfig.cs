...
namespace Energinet.DataHub.MarketParticipant.Infrastructure
{
    public class ServiceBusConfig
    {
        public ServiceBusConfig(string connectionString, string topicMarketParticipantChanged)
        {
            ...
            Guard.ThrowIfNull(topicMarketParticipantChanged, nameof(topicMarketParticipantChanged));

            ConnectionString = connectionString;
            TopicMarketParticipantChanged = topicMarketParticipantChanged;
        }

        public string ConnectionString { get; }
        public string TopicMarketParticipantChanged { get; }
    }
}
