...
{
    public sealed class UserActorUserRoleEntityConfiguration : IEntityTypeConfiguration<UserActorUserRoleEntity>
    {
        public void Configure(EntityTypeBuilder<UserActorUserRoleEntity> builder)
        {
