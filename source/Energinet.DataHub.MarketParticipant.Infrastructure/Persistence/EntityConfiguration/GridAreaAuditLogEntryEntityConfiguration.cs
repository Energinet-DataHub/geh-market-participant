...
{
    public class GridAreaAuditLogEntryEntityConfiguration : IEntityTypeConfiguration<GridAreaAuditLogEntryEntity>
    {
        public void Configure(EntityTypeBuilder<GridAreaAuditLogEntryEntity> builder)
        {
