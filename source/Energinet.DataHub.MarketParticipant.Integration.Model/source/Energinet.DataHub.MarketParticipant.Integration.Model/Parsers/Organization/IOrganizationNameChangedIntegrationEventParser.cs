...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Organization
{
    ...
    /// </summary>
    public interface IOrganizationNameChangedIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(OrganizationNameChangedIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(OrganizationNameChangedIntegrationEvent integrationEvent);
    }
}
