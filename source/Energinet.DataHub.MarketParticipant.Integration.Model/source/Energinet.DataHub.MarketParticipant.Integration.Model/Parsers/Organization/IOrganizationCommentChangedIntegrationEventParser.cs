...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Organization
{
    ...
    /// </summary>
    public interface IOrganizationCommentChangedIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(OrganizationCommentChangedIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(OrganizationCommentChangedIntegrationEvent integrationEvent);
    }
}
