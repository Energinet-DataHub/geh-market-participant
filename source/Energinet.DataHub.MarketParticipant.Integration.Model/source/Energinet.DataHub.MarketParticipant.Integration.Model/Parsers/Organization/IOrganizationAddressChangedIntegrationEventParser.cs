...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Organization
{
    ...
    /// </summary>
    public interface IOrganizationAddressChangedIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(OrganizationAddressChangedIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(OrganizationAddressChangedIntegrationEvent integrationEvent);
    }
}
