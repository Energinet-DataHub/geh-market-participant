...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IActorExternalIdChangedIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(ActorExternalIdChangedIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(ActorExternalIdChangedIntegrationEvent integrationEvent);
    }
}
