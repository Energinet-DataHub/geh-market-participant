...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IGridAreaRemovedFromActorIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(GridAreaRemovedFromActorIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(GridAreaRemovedFromActorIntegrationEvent integrationEvent);
    }
}
