...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IMeteringPointTypeRemovedFromActorIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] ParseToSharedIntegrationEvent(MeteringPointTypeRemovedFromActorIntegrationEvent integrationEvent);
    }
}
