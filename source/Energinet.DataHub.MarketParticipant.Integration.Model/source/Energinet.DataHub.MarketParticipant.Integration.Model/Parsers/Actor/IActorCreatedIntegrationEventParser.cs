...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IActorCreatedIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(ActorCreatedIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(ActorCreatedIntegrationEvent integrationEvent);
    }
}
