...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IGridAreaAddedToActorIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(GridAreaAddedToActorIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(GridAreaAddedToActorIntegrationEvent integrationEvent);
    }
}
