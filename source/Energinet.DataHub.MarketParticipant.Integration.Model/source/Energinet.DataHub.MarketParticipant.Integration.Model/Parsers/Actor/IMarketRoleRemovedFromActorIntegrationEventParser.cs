...
namespace Energinet.DataHub.MarketParticipant.Integration.Model.Parsers.Actor
{
    ...
    /// </summary>
    public interface IMarketRoleRemovedFromActorIntegrationEventParser
    {
        /// <summary>
        /// Parses the event.
        /// </summary>
        ...
        byte[] Parse(MarketRoleRemovedFromActorIntegrationEvent integrationEvent);
        ...
        byte[] ParseToSharedIntegrationEvent(MarketRoleRemovedFromActorIntegrationEvent integrationEvent);
    }
}
