...
{
    public sealed record OrganizationNameChangedIntegrationEvent : BaseIntegrationEvent
    {
        /// <summary>
        ...
        public OrganizationNameChangedIntegrationEvent(
            Guid id,
        ...
        : base(id, eventCreated)
        {
            ...
            Name = name;
            Type = nameof(OrganizationNameChangedIntegrationEvent);
        }
