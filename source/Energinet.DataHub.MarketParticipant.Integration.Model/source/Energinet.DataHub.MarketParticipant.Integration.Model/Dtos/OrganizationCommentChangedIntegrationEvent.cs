...
{
    public sealed record OrganizationCommentChangedIntegrationEvent : BaseIntegrationEvent
    {
        /// <summary>
        ...
        /// <param name="comment">organization comment update</param>
        public OrganizationCommentChangedIntegrationEvent(
            Guid id,
