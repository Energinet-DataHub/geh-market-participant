...
{
    public sealed class RemoveGridAreaIntegrationEvent
    {
        public RemoveGridAreaIntegrationEvent(Guid eventId, Guid actorId, EicFunction function, Guid gridAreaId)
        {
            EventId = eventId;
            ActorId = actorId;
            Function = function;
