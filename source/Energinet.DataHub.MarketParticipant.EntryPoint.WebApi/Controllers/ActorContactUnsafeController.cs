...
namespace Energinet.DataHub.MarketParticipant.EntryPoint.WebApi.Controllers
{
    ...
    [Route("organization")]
    public sealed class ActorContactUnsafeController : ControllerBase
    {
        private readonly ILogger<ActorContactUnsafeController> _logger;
        private readonly IMediator _mediator;

        public ActorContactUnsafeController(ILogger<ActorContactUnsafeController> logger, IMediator mediator)
        {
            _logger = logger;
            _mediator = mediator;
        }
