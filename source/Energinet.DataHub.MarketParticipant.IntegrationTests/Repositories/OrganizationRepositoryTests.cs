...
namespace Energinet.DataHub.MarketParticipant.IntegrationTests.Repositories
{
    ...
    public sealed class OrganizationRepositoryTests
    {
        ...
        public async Task AddOrUpdateAsync_OneOrganization_CanReadBack()
        {
            ...
            var testOrg = new Organization("Test", MockedBusinessRegisterIdentifier.New(), _validAddress, new OrganizationDomain("energinet.dk"), "Test Comment");
        ...
        public async Task AddOrUpdateAsync_OneOrganizationWithAddress_CanReadBack()
        {
            ...
            var testOrg = new Organization("Test", MockedBusinessRegisterIdentifier.New(), _validAddress, new OrganizationDomain("energinet.dk"), null);
        ...
        public async Task AddOrUpdateAsync_ActorAdded_CanReadBack()
        {
            ...
            var organization = new Organization("Test", MockedBusinessRegisterIdentifier.New(), _validAddress, new OrganizationDomain("energinet.dk"), null);
