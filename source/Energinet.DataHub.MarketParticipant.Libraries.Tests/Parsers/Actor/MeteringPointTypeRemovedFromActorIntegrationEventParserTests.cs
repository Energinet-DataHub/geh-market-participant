...
{
    [UnitTest]
    public class MeteringPointTypeRemovedFromActorIntegrationEventParserTests
    {
        [Fact]
        ...
        [Fact]
        public void Parse_Invalid_FromBytes()
        {
            // Arrange
            var target = new MeteringPointTypeRemovedFromActorIntegrationEventParser();
            var contract = new MeteringPointTypeRemovedFromActorIntegrationEventContract
            {
                ...
                Type = nameof(MeteringPointTypeRemovedFromActorIntegrationEvent)
            };
