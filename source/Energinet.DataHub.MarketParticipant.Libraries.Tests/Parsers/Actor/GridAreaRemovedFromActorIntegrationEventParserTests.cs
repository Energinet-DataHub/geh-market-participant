...
{
    [UnitTest]
    public class GridAreaRemovedFromActorIntegrationEventParserTests
    {
        [Fact]
        public void Parse_InputValid_ParsesCorrectly()
        {
            // arrange
            var target = new GridAreaRemovedFromActorIntegrationEventParser();
            ...
            var actualEvent = GridAreaRemovedFromActorIntegrationEventParser.Parse(actualBytes);
        ...
        public void Parse_InvalidGuid_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => GridAreaRemovedFromActorIntegrationEventParser.Parse(contract.ToByteArray()));
        }
