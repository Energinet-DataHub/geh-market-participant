...
{
    [UnitTest]
    public class GridAreaAddedToActorIntegrationEventParserTests
    {
        [Fact]
        public void Parse_InputValid_ParsesCorrectly()
        {
            // arrange
            var target = new GridAreaAddedToActorIntegrationEventParser();
            ...
            var actualEvent = GridAreaAddedToActorIntegrationEventParser.Parse(actualBytes);
        ...
        public void Parse_InvalidGuid_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => GridAreaAddedToActorIntegrationEventParser.Parse(contract.ToByteArray()));
        }
        ...
        public void Parse_InvalidInput_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => GridAreaAddedToActorIntegrationEventParser.Parse(new byte[] { 1, 2, 3 }));
        }
    }
}
