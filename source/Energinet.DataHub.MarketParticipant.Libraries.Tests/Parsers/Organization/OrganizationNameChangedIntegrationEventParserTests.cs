...
namespace Energinet.DataHub.MarketParticipant.Libraries.Tests.Parsers.Organization
{
    ...
    public class OrganizationNameChangedIntegrationEventParserTests
    {
        ...
        public void Parse_InputValid_ParsesCorrectly()
        {
            ...
            var actualEvent = OrganizationNameChangedIntegrationEventParser.Parse(actualBytes);
        ...
        public void Parse_InvalidGuid_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => OrganizationNameChangedIntegrationEventParser.Parse(contract.ToByteArray()));
        }
        ...
        public void Parse_InvalidInput_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => OrganizationNameChangedIntegrationEventParser.Parse(new byte[] { 1, 2, 3 }));
        }
    }
}
