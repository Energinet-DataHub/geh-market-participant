...
namespace Energinet.DataHub.MarketParticipant.Libraries.Tests.Parsers.Organization
{
    ...
    public class OrganizationUpdatedIntegrationEventParserTests
    {
        ...
        public void Parse_InputValid_ParsesCorrectly()
        {
            ...
            var actualEvent = OrganizationUpdatedIntegrationEventParser.Parse(actualBytes);
        ...
        public void Parse_InvalidGuid_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => OrganizationUpdatedIntegrationEventParser.Parse(contract.ToByteArray()));
        }
        ...
        public void Parse_InvalidInput_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => OrganizationUpdatedIntegrationEventParser.Parse(new byte[] { 1, 2, 3 }));
        }
    }
}
