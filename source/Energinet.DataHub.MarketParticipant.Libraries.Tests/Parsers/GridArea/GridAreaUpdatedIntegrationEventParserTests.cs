...
namespace Energinet.DataHub.MarketParticipant.Libraries.Tests.Parsers.GridArea
{
    ...
    public class GridAreaUpdatedIntegrationEventParserTests
    {
        ...
        public void Parse_InputValid_ParsesCorrectly()
        {
            ...
            var actualEvent = GridAreaUpdatedIntegrationEventParser.Parse(actualBytes);
        ...
        public void Parse_InvalidGuid_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => GridAreaUpdatedIntegrationEventParser.Parse(contract.ToByteArray()));
        }
        ...
        public void Parse_InvalidInput_ThrowsException()
        {
            ...
            // Act + Assert
            Assert.Throws<MarketParticipantException>(() => GridAreaUpdatedIntegrationEventParser.Parse(new byte[] { 1, 2, 3 }));
        }
    }
}
