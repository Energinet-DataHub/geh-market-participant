...
public sealed class OrganizationDomainTests
{
    ...
    [InlineData("www.energinet.dk", false)]
    [InlineData("https://www.energinet.dk", false)]
    [InlineData("https://energinet.dk", false)]
    [InlineData("energinet.nottopleveldomain", false)]
    ...
    [Fact]
    public void Ctor_Called_Validates()
    {
        // arrange, act, assert
        Assert.Throws<ValidationException>(() => new OrganizationDomain("https://energinet.dk"));
    }
}
