...
namespace Energinet.DataHub.MarketParticipant.Domain.Services
{
    public class GridAreaFactoryService : IGridAreaFactoryService
    {
        ...
        public async Task<GridArea> CreateAsync(string code, string name, PriceAreaCode priceAreaCode)
        {
            ...
            await _gridAreaIntegrationEventsQueueService
                .EnqueueGridAreaUpdatedEventAsync(savedGridArea, savedGridAreaLink)
                .ConfigureAwait(false);
